...
def register_generated_tools(mcp, _get_client):
    ...
    def accounts_move_account_to_profile(account_id: str, profile_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.accounts.move_account_to_profile(account_id=account_id, profile_id=profile_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def accounts_reply_to_google_business_review(account_id: str, review_id: str, comment: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.accounts.reply_to_google_business_review(account_id=account_id, review_id=review_id, comment=comment)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def accounts_delete_google_business_review_reply(account_id: str, review_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.accounts.delete_google_business_review_reply(account_id=account_id, review_id=review_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ad_campaigns_list_ad_campaigns(page: int = 1, limit: int = 20, source: str = "all", platform: str | None = None, status: str | None = None, ad_account_id: str | None = None, account_id: str | None = None, profile_id: str | None = None, from_date: str | None = None, to_date: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ad_campaigns.list_ad_campaigns(page=page, limit=limit, source=source, platform=platform, status=status, ad_account_id=ad_account_id, account_id=account_id, profile_id=profile_id, from_date=from_date, to_date=to_date)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ad_campaigns_get_ad_tree(page: int = 1, limit: int = 20, source: str = "all", platform: str | None = None, status: str | None = None, ad_account_id: str | None = None, account_id: str | None = None, profile_id: str | None = None, from_date: str | None = None, to_date: str | None = None, sort: str = "newest") -> str:
        ...
        client = _get_client()
        try:
            response = client.ad_campaigns.get_ad_tree(page=page, limit=limit, source=source, platform=platform, status=status, ad_account_id=ad_account_id, account_id=account_id, profile_id=profile_id, from_date=from_date, to_date=to_date, sort=sort)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ad_campaigns_get_ads_timeline(account_id: str, ad_account_id: str | None = None, from_date: str | None = None, to_date: str | None = None, platform: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ad_campaigns.get_ads_timeline(account_id=account_id, ad_account_id=ad_account_id, from_date=from_date, to_date=to_date, platform=platform)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_list_ads(page: int = 1, limit: int = 50, source: str = "all", status: str | None = None, platform: str | None = None, account_id: str | None = None, ad_account_id: str | None = None, profile_id: str | None = None, campaign_id: str | None = None, platform_ad_id: str | None = None, effective_object_story_id: str | None = None, effective_instagram_media_id: str | None = None, from_date: str | None = None, to_date: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.list_ads(page=page, limit=limit, source=source, status=status, platform=platform, account_id=account_id, ad_account_id=ad_account_id, profile_id=profile_id, campaign_id=campaign_id, platform_ad_id=platform_ad_id, effective_object_story_id=effective_object_story_id, effective_instagram_media_id=effective_instagram_media_id, from_date=from_date, to_date=to_date)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_get_ad_comments(ad_id: str, placement: str | None = None, limit: int = 25, cursor: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.get_ad_comments(ad_id=ad_id, placement=placement, limit=limit, cursor=cursor)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    **TikTok**: only `goal: conversions` uses it.
    ...
    def ads_get_conversion_destination(account_id: str, destination_id: str, ad_account_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.get_conversion_destination(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_delete_conversion_destination(account_id: str, destination_id: str, ad_account_id: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.delete_conversion_destination(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_list_conversion_associations(account_id: str, destination_id: str, ad_account_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.list_conversion_associations(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_add_conversion_associations(account_id: str, destination_id: str, ad_account_id: str, campaign_ids: list[str] | None) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.add_conversion_associations(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id, campaign_ids=campaign_ids)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_remove_conversion_associations(account_id: str, destination_id: str, ad_account_id: str, campaign_ids: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.remove_conversion_associations(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id, campaign_ids=campaign_ids)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def ads_get_conversion_metrics(account_id: str, destination_id: str, ad_account_id: str, start_date: str, end_date: str | None = None, granularity: str = "DAILY") -> str:
        ...
        client = _get_client()
        try:
            response = client.ads.get_conversion_metrics(account_id=account_id, destination_id=destination_id, ad_account_id=ad_account_id, start_date=start_date, end_date=end_date, granularity=granularity)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def broadcasts_update_broadcast(broadcast_id: str, name: str | None = None, description: str | None = None, message: dict[str, Any] | None = None, template: dict[str, Any] | None = None, segment_filters: dict[str, Any] | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.broadcasts.update_broadcast(broadcast_id=broadcast_id, name=name, description=description, message=message, template=template, segment_filters=segment_filters)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def comment_automations_create_comment_automation(profile_id: str, account_id: str, name: str, dm_message: str, platform_post_id: str | None = None, post_id: str | None = None, post_title: str | None = None, keywords: list[str] | None = None, match_mode: str = "contains", buttons: list[dict[str, Any]] | None = None, comment_reply: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.comment_automations.create_comment_automation(profile_id=profile_id, account_id=account_id, platform_post_id=platform_post_id, post_id=post_id, post_title=post_title, name=name, keywords=keywords, match_mode=match_mode, dm_message=dm_message, buttons=buttons, comment_reply=comment_reply)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def comment_automations_update_comment_automation(automation_id: str, name: str | None = None, keywords: list[str] | None = None, match_mode: str | None = None, dm_message: str | None = None, buttons: list[dict[str, Any]] | None = None, comment_reply: str | None = None, is_active: bool | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.comment_automations.update_comment_automation(automation_id=automation_id, name=name, keywords=keywords, match_mode=match_mode, dm_message=dm_message, buttons=buttons, comment_reply=comment_reply, is_active=is_active)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def connect_get_facebook_pages(account_id: str, refresh: bool | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.connect.get_facebook_pages(account_id=account_id, refresh=refresh)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def instagram_get_instagram_story_insights(account_id: str, story_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.instagram.get_instagram_story_insights(account_id=account_id, story_id=story_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def messages_mark_conversation_read(conversation_id: str, account_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.messages.mark_conversation_read(conversation_id=conversation_id, account_id=account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def sequences_update_sequence(sequence_id: str, name: str | None = None, description: str | None = None, steps: list[dict[str, Any]] | None = None, exit_on_reply: bool | None = None, exit_on_unsubscribe: bool | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.sequences.update_sequence(sequence_id=sequence_id, name=name, description=description, steps=steps, exit_on_reply=exit_on_reply, exit_on_unsubscribe=exit_on_unsubscribe)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_list_tracking_tags(account_id: str, ad_account_id: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.list_tracking_tags(account_id=account_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_create_tracking_tag(account_id: str, ad_account_id: str, name: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.create_tracking_tag(account_id=account_id, ad_account_id=ad_account_id, name=name)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_get_tracking_tag(account_id: str, tag_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.get_tracking_tag(account_id=account_id, tag_id=tag_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    zp=zip.
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.update_tracking_tag(account_id=account_id, tag_id=tag_id, name=name, enable_automatic_matching=enable_automatic_matching, automatic_matching_fields=automatic_matching_fields, first_party_cookie_status=first_party_cookie_status, data_use_setting=data_use_setting)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_list_tracking_tag_shared_accounts(account_id: str, tag_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.list_tracking_tag_shared_accounts(account_id=account_id, tag_id=tag_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_add_tracking_tag_shared_account(account_id: str, tag_id: str, ad_account_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.add_tracking_tag_shared_account(account_id=account_id, tag_id=tag_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_remove_tracking_tag_shared_account(account_id: str, tag_id: str, ad_account_id: str | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.remove_tracking_tag_shared_account(account_id=account_id, tag_id=tag_id, ad_account_id=ad_account_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def tracking_tags_get_tracking_tag_stats(account_id: str, tag_id: str, aggregation: str = "event", start_time: int | None = None, end_time: int | None = None) -> str:
        ...
        client = _get_client()
        try:
            response = client.tracking_tags.get_tracking_tag_stats(account_id=account_id, tag_id=tag_id, aggregation=aggregation, start_time=start_time, end_time=end_time)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
