...
def register_generated_tools(mcp, _get_client):
    ...
    def accounts_batch_get_google_business_reviews(
        account_id: str, location_names: str, page_size: int = 50, page_token: str = ""
    ) -> str:
        """Batch get reviews
    ...
    @mcp.tool()
    def ad_campaigns_bulk_update_ad_campaign_status(status: str, campaigns: str) -> str:
    ...
    def gmb_services_update_google_business_services(
        account_id: str, service_items: str, location_id: str = ""
    ) -> str:
        """Replace services
