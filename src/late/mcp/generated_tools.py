...
def register_generated_tools(mcp, _get_client):
    ...
    def account_groups_create_account_group(
        name: str, account_ids: list[str] | None, profile_id: str = ""
    ) -> str:
        """Create group
    ...
    def account_groups_update_account_group(
        group_id: str, name: str = "", account_ids: list[str] | None = None
    ) -> str:
        """Update group
    ...
    def custom_fields_update_custom_field(
        field_id: str, name: str = "", options: list[str] | None = None
    ) -> str:
        """Update custom field
