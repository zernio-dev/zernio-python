...
def register_generated_tools(mcp, _get_client):
    ...
    @mcp.tool()
    def ad_campaigns_list_ad_campaigns(page: int = 1, limit: int = 20, source: str = "all", platform: str | None = None, status: str | None = None, ad_account_id: str | None = None, account_id: str | None = None, profile_id: str | None = None) -> str:
        """List campaigns
    ...
    @mcp.tool()
    def ad_campaigns_get_ad_tree(page: int = 1, limit: int = 20, source: str = "all", platform: str | None = None, status: str | None = None, ad_account_id: str | None = None, account_id: str | None = None, profile_id: str | None = None, from_date: str | None = None, to_date: str | None = None) -> str:
        """Get campaign tree
    ...
    @mcp.tool()
    def ads_list_ads(page: int = 1, limit: int = 50, source: str = "all", status: str | None = None, platform: str | None = None, account_id: str | None = None, ad_account_id: str | None = None, profile_id: str | None = None, campaign_id: str | None = None, from_date: str | None = None, to_date: str | None = None) -> str:
        """List ads
    ...
    @mcp.tool()
    def ads_get_ad_comments(ad_id: str, limit: int = 25, cursor: str | None = None) -> str:
    ...
    @mcp.tool()
    def ads_create_standalone_ad(account_id: str, ad_account_id: str, name: str, goal: str | None = None, budget_amount: float | None = None, budget_type: str | None = None, currency: str | None = None, headline: str | None = None, long_headline: str | None = None, body: str | None = None, call_to_action: str | None = None, link_url: str | None = None, image_url: str | None = None, images: dict[str, Any] | None = None, video: dict[str, Any] | None = None, creatives: list[dict[str, Any]] | None = None, ad_set_id: str | None = None, business_name: str | None = None, board_id: str | None = None, countries: list[str] | None = None, cities: list[dict[str, Any]] | None = None, regions: list[dict[str, Any]] | None = None, age_min: int | None = None, age_max: int | None = None, interests: list[dict[str, Any]] | None = None, end_date: str | None = None, audience_id: str | None = None, campaign_type: str = "display", keywords: list[str] | None = None, additional_headlines: list[str] | None = None, additional_descriptions: list[str] | None = None, advantage_audience: int | None = None, gender: str = "all", bid_strategy: str | None = None, bid_amount: float | None = None, roas_average_floor: float | None = None, dsa_beneficiary: str | None = None, dsa_payor: str | None = None, brand_identity: dict[str, Any] | None = None, identity_type: str | None = None, promoted_object: dict[str, Any] | None = None) -> str:
    ...
    @mcp.tool()
    def ads_create_ctwa_ad(account_id: str, ad_account_id: str, name: str, headline: str, body: str, budget_amount: float, budget_type: str, image_url: str | None = None, video: dict[str, Any] | None = None, currency: str | None = None, end_date: str | None = None, countries: list[str] | None = None, age_min: int | None = None, age_max: int | None = None, interests: list[dict[str, Any]] | None = None, audience_id: str | None = None, advantage_audience: int | None = None, objective: str | None = None, dsa_beneficiary: str | None = None, dsa_payor: str | None = None) -> str:
    ...
    @mcp.tool()
    def comment_automations_create_comment_automation(profile_id: str, account_id: str, name: str, dm_message: str, platform_post_id: str | None = None, post_id: str | None = None, post_title: str | None = None, keywords: list[str] | None = None, match_mode: str = "contains", comment_reply: str | None = None) -> str:
    ...
    @mcp.tool()
    def comment_automations_update_comment_automation(automation_id: str, name: str | None = None, keywords: list[str] | None = None, match_mode: str | None = None, dm_message: str | None = None, comment_reply: str | None = None, is_active: bool | None = None) -> str:
