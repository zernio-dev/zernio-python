...
def register_generated_tools(mcp, _get_client):
    ...
    @mcp.tool()
    def accounts_list_accounts(profile_id: str = "", platform: str = "", include_over_limit: bool = False) -> str:
        """List accounts
        ...
        client = _get_client()
        try:
            response = client.accounts.list_accounts(profile_id=profile_id, platform=platform, include_over_limit=include_over_limit)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def connect_select_google_business_location(profile_id: str, location_id: str, temp_token: str, user_profile: str = "", redirect_url: str = "") -> str:
        """Select GBP location
        ...
        client = _get_client()
        try:
            response = client.connect.select_google_business_location(profile_id=profile_id, location_id=location_id, temp_token=temp_token, user_profile=user_profile, redirect_url=redirect_url)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def logs_list_posts_logs(status: str = "", platform: str = "", action: str = "", days: int = 7, limit: int = 50, skip: int = 0, search: str = "") -> str:
        ...
        client = _get_client()
        try:
            response = client.logs.list_posts_logs(status=status, platform=platform, action=action, days=days, limit=limit, skip=skip, search=search)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def logs_list_connection_logs(platform: str = "", event_type: str = "", status: str = "", days: int = 7, limit: int = 50, skip: int = 0) -> str:
    ...
    @mcp.tool()
    def posts_update_post(post_id: str, content: str = "", scheduled_for: str = "", tiktok_settings: str = "", recycling: str = "") -> str:
        """Update post
        ...
        client = _get_client()
        try:
            response = client.posts.update_post(post_id=post_id, content=content, scheduled_for=scheduled_for, tiktok_settings=tiktok_settings, recycling=recycling)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def posts_update_post_metadata(post_id: str, platform: str, title: str = "", description: str = "", tags: str = "", category_id: str = "", privacy_status: str = "") -> str:
        ...
        client = _get_client()
        try:
            response = client.posts.update_post_metadata(post_id=post_id, platform=platform, title=title, description=description, tags=tags, category_id=category_id, privacy_status=privacy_status)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def tools_download_you_tube_video(url: str, action: str = "download", format: str = "video", quality: str = "hd", format_id: str = "") -> str:
    ...
    @mcp.tool()
    def tools_download_tik_tok_video(url: str, action: str = "download", format_id: str = "") -> str:
    ...
    @mcp.tool()
    def tools_download_twitter_media(url: str, action: str = "download", format_id: str = "") -> str:
    ...
    @mcp.tool()
    def webhooks_get_webhook_logs(limit: int = 50, status: str = "", event: str = "", webhook_id: str = "") -> str:
        """Get delivery logs
    ...
    @mcp.tool()
    def whatsapp_send_whats_app_bulk(account_id: str, recipients: str, template: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.send_whats_app_bulk(account_id=account_id, recipients=recipients, template=template)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_get_whats_app_contacts(account_id: str, search: str = "", tag: str = "", group: str = "", opted_in: str = "", limit: int = 50, skip: int = 0) -> str:
        """List contacts
        ...
        client = _get_client()
        try:
            response = client.whatsapp.get_whats_app_contacts(account_id=account_id, search=search, tag=tag, group=group, opted_in=opted_in, limit=limit, skip=skip)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_create_whats_app_contact(account_id: str, phone: str, name: str, email: str = "", company: str = "", tags: str = "", groups: str = "", is_opted_in: bool = True, custom_fields: str = "", notes: str = "") -> str:
        """Create contact
        ...
        client = _get_client()
        try:
            response = client.whatsapp.create_whats_app_contact(account_id=account_id, phone=phone, name=name, email=email, company=company, tags=tags, groups=groups, is_opted_in=is_opted_in, custom_fields=custom_fields, notes=notes)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_update_whats_app_contact(contact_id: str, name: str = "", email: str = "", company: str = "", tags: str = "", groups: str = "", is_opted_in: bool = False, is_blocked: bool = False, custom_fields: str = "", notes: str = "") -> str:
        """Update contact
        ...
        client = _get_client()
        try:
            response = client.whatsapp.update_whats_app_contact(contact_id=contact_id, name=name, email=email, company=company, tags=tags, groups=groups, is_opted_in=is_opted_in, is_blocked=is_blocked, custom_fields=custom_fields, notes=notes)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_import_whats_app_contacts(account_id: str, contacts: str, default_tags: str = "", default_groups: str = "", skip_duplicates: bool = True) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.import_whats_app_contacts(account_id=account_id, contacts=contacts, default_tags=default_tags, default_groups=default_groups, skip_duplicates=skip_duplicates)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_bulk_update_whats_app_contacts(action: str, contact_ids: str, tags: str = "", groups: str = "") -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.bulk_update_whats_app_contacts(action=action, contact_ids=contact_ids, tags=tags, groups=groups)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_bulk_delete_whats_app_contacts(contact_ids: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.bulk_delete_whats_app_contacts(contact_ids=contact_ids)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_rename_whats_app_group(account_id: str, old_name: str, new_name: str) -> str:
        """Rename group
        ...
        client = _get_client()
        try:
            response = client.whatsapp.rename_whats_app_group(account_id=account_id, old_name=old_name, new_name=new_name)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_delete_whats_app_group(account_id: str, group_name: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.delete_whats_app_group(account_id=account_id, group_name=group_name)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_get_whats_app_broadcasts(account_id: str, status: str = "", limit: int = 50, skip: int = 0) -> str:
        """List broadcasts
    ...
    @mcp.tool()
    def whatsapp_create_whats_app_broadcast(account_id: str, name: str, template: str, description: str = "", recipients: str = "") -> str:
        """Create broadcast
        ...
        client = _get_client()
        try:
            response = client.whatsapp.create_whats_app_broadcast(account_id=account_id, name=name, description=description, template=template, recipients=recipients)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_get_whats_app_broadcast(broadcast_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.get_whats_app_broadcast(broadcast_id=broadcast_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_delete_whats_app_broadcast(broadcast_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.delete_whats_app_broadcast(broadcast_id=broadcast_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_send_whats_app_broadcast(broadcast_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.send_whats_app_broadcast(broadcast_id=broadcast_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_schedule_whats_app_broadcast(broadcast_id: str, scheduled_at: str) -> str:
        """Schedule broadcast
        ...
        client = _get_client()
        try:
            response = client.whatsapp.schedule_whats_app_broadcast(broadcast_id=broadcast_id, scheduled_at=scheduled_at)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    def whatsapp_cancel_whats_app_broadcast_schedule(broadcast_id: str) -> str:
        ...
        client = _get_client()
        try:
            response = client.whatsapp.cancel_whats_app_broadcast_schedule(broadcast_id=broadcast_id)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_get_whats_app_broadcast_recipients(broadcast_id: str, status: str = "", limit: int = 100, skip: int = 0) -> str:
        """List recipients
        ...
        client = _get_client()
        try:
            response = client.whatsapp.get_whats_app_broadcast_recipients(broadcast_id=broadcast_id, status=status, limit=limit, skip=skip)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_add_whats_app_broadcast_recipients(broadcast_id: str, recipients: str) -> str:
        """Add recipients
        ...
        client = _get_client()
        try:
            response = client.whatsapp.add_whats_app_broadcast_recipients(broadcast_id=broadcast_id, recipients=recipients)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
    ...
    @mcp.tool()
    def whatsapp_remove_whats_app_broadcast_recipients(broadcast_id: str, phones: str) -> str:
        """Remove recipients
        ...
        client = _get_client()
        try:
            response = client.whatsapp.remove_whats_app_broadcast_recipients(broadcast_id=broadcast_id, phones=phones)
            return _format_response(response)
        except Exception as e:
            return f'Error: {e}'
