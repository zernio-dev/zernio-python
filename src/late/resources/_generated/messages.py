...
class MessagesResource:
    ...
    def create_inbox_conversation(self, account_id: str, *, participant_id: str | None = None, participant_username: str | None = None, message: str | None = None, skip_dm_check: bool | None = False) -> dict[str, Any]:
        """Create conversation"""
    ...
    async def acreate_inbox_conversation(self, account_id: str, *, participant_id: str | None = None, participant_username: str | None = None, message: str | None = None, skip_dm_check: bool | None = False) -> dict[str, Any]:
