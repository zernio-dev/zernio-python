...
class SlackResource:
    ...
    def list_slack_members(
        self, account_id: str, *, query: str | None = None, limit: int | None = 50
    ) -> dict[str, Any]:
        ...
        return self._client._get(
            f"/v1/accounts/{account_id}/slack-members", params=params
        )

    async def alist_slack_members(
        self, account_id: str, *, query: str | None = None, limit: int | None = 50
    ) -> dict[str, Any]:
        """List Slack workspace members (async)"""
        params = self._build_params(
            query=query,
            limit=limit,
        )
